 ...
 */
final class BindingsApi extends LoadedWebViewExtension implements
    BindingsApiInterface,
    \IteratorAggregate
{
    /**
     * @see BindingsExtensionCreateInfo::$rpcContext
     *
    ...
    {
        $this->scripts->add($this->packer->pack(
            path: $name,
