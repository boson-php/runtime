...
final readonly class ExtensionFileDetector implements FileDetectorInterface
{
     ...
     * @link https://github.com/php/php-src/blob/php-8.4.6/sapi/cli/mime_type_map.h#L28
     */
    public const array MIME_TYPES_FOR_EXTENSIONS = [
        // List of additional mime types defined (supported) by chromium engine:
        // https://github.com/chromium/chromium/blob/137.0.7122.1/net/base/mime_util.cc#L95-L255
        'ehtml' => 'text/html',
        'jfif' => 'image/jpeg',
        ...
        // List of mime types defined from PHP CLI Server:
        // https://github.com/php/php-src/blob/php-8.4.6/sapi/cli/mime_type_map.h#L28
